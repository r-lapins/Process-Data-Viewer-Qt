...
{
    if (parent.isValid() || !m_dataSet.has_value()) {
        return 0;
    }
...
{
    if (!index.isValid() || !m_dataSet.has_value()) {
        return {};
    }
    ...
    switch (index.column()) {
    case 0:
        return formatTimestamp(sample.timestamp);
    case 1:
        return QString::fromStdString(sample.sensor);
    case 2:
        return sample.value;
    default:
        return {};
